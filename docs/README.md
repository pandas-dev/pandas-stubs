...
The stubs are developed with a certain [philosophy](philosophy.md) and governed by formal [Architecture Decision Records](architecture/README.md) that should be 
