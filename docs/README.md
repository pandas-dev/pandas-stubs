...
The stubs are developed with a certain [philosophy](philosophy.md) and [architecture](architecture.md) that should be 
...
- [Type architecture and container hierarchy](architecture.md)
