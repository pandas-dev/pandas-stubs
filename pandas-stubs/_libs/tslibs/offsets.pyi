...
class _NotForPeriodSingleConstructorOffset(BaseOffset):
    def __reduce__(self): ...
...
class _NotForPeriodBusinessMixin(_NotForPeriodSingleConstructorOffset):
    def __init__(
        self, n: int = ..., normalize: bool = ..., offset: timedelta = ...
    ) -> None: ...

class _NotForPeriodDtype: ...
class BusinessDay(_NotForPeriodBusinessMixin): ...
