...
class Timestamp(datetime):
    ...
    @overload
    def __add__(self: _DatetimeT, other: Series) -> TimestampSeries: ...
    @overload
    def __add__(self: _DatetimeT, other: TimedeltaIndex) -> DatetimeIndex: ...
    @overload
    def __radd__(self: _DatetimeT, other: timedelta) -> _DatetimeT: ...
    @overload
    def __radd__(self: _DatetimeT, other: TimedeltaIndex) -> DatetimeIndex: ...
    @overload  # type: ignore[override]
    ...
    @overload
    def __sub__(self: _DatetimeT, other: TimedeltaIndex) -> DatetimeIndex: ...
    @overload
    def __sub__(self: _DatetimeT, other: TimedeltaSeries) -> TimestampSeries: ...
    @overload
    def __sub__(
        self: _DatetimeT, other: npt.NDArray[np.timedelta64]
    ) -> npt.NDArray[np.datetime64]: ...
    @overload  # type: ignore[override]
