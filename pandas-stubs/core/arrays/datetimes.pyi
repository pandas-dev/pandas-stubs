...
class DatetimeArray(DatetimeLikeArrayMixin, TimelikeOps, DatelikeOps):
    ...
    @tz.setter
    def tz(self, value: Any) -> Never: ...  # setter should not be used
    @property
    ...
    def to_pydatetime(self) -> np_ndarray: ...
    ...
    is_year_end = ...
    is_leap_year = ...
    def to_julian_date(self) -> np_ndarray_float: ...
