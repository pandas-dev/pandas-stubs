...
class SparseArray(OpsMixin, ExtensionArray):
    ...
    @override
    def shift(self, periods: int = 1, fill_value: Scalar | None = None) -> Self: ...  # type: ignore[override] # pyright: ignore[reportIncompatibleMethodOverride] # pyrefly: ignore[bad-override] # ty: ignore[invalid-method-override]
    @override
