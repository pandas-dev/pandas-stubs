...
class TimedeltaArray(DatetimeLikeArrayMixin, TimelikeOps):
    ...
    def __divmod__(  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride] # pyrefly: ignore[bad-param-name-override]
        self, other: Any
    ) -> tuple[np_1darray_anyint, TimedeltaArray]: ...
    def __rdivmod__(  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride] # pyrefly: ignore[bad-param-name-override]
        self, other: Any
    ) -> tuple[np_1darray_anyint, TimedeltaArray]: ...
