...
class TimedeltaArray(TimelikeOps):
    ...
    def __divmod__(  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride] # pyrefly: ignore[bad-param-name-override]  # ty: ignore[invalid-method-override]
        self, other: Any
    ) -> tuple[np_1darray_anyint, TimedeltaArray]: ...
    def __rdivmod__(  # type: ignore[override]  # pyright: ignore[reportIncompatibleMethodOverride] # pyrefly: ignore[bad-param-name-override]  # ty: ignore[invalid-method-override]
        self, other: Any
    ) -> tuple[np_1darray_anyint, TimedeltaArray]: ...
