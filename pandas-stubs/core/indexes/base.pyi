...
class Index(IndexOpsMixin, PandasObject):
    ...
    def __and__(self, other: Any) -> Never: ...
    def __rand__(self, other: Any) -> Never: ...
    def __or__(self, other: Any) -> Never: ...
    def __ror__(self, other: Any) -> Never: ...
    def __xor__(self, other: Any) -> Never: ...
    def __rxor__(self, other: Any) -> Never: ...
