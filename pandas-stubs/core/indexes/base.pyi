...
class Index(IndexOpsMixin[S1], ElementOpsMixin[S1]):
    ...
    @overload
    def __add__(self: Index[Never], other: complex | ListLike | Index) -> Index: ...
    @overload
    ...
    @overload
    def __radd__(self: Index[Never], other: complex | ListLike | Index) -> Index: ...
    @overload
    def __radd__(
    ...
    @overload
    def __sub__(self: Index[Never], other: complex | ListLike | Index) -> Index: ...
    @overload
    ...
    @overload
    def __mul__(self: Index[Never], other: complex | ListLike | Index) -> Index: ...
    @overload
    ...
    @overload
    def __rmul__(self: Index[Never], other: complex | ListLike | Index) -> Index: ...
    @overload
