...
class DatetimeIndex(DatetimeTimedeltaMixin, DatetimeDelegateMixin):
    ...
    def __lt__(self, Timestamp) -> np_ndarray_bool: ...
    def __le__(self, Timestamp) -> np_ndarray_bool: ...
    def __gt__(self, Timestamp) -> np_ndarray_bool: ...
    def __ge__(self, Timestamp) -> np_ndarray_bool: ...
