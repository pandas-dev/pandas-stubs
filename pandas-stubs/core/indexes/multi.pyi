...
class MultiIndex(Index):
    ...
    @overload
    def union(self, other: MultiIndex | Index[tuple[Hashable, ...]] | list[tuple[Hashable, ...]], sort: bool | None = None,) -> Self: ...
    @overload
    def union(self, other: list[HashableT] | Index, sort: bool | None = None,) -> Index: ...
