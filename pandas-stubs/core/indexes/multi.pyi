...
class MultiIndex(Index):
    ...
    def set_levels(
        self, levels, inplace: bool = ..., *, level=..., verify_integrity: bool = ...
    ): ...
    @property
    def codes(self): ...
    def set_codes(
        self, codes, inplace: bool = ..., *, level=..., verify_integrity: bool = ...
    ): ...
    ...
    def drop(self, codes, errors: str = ..., level=...) -> MultiIndex: ...
