...
class TimedeltaIndex(DatetimeTimedeltaMixin[Timedelta], TimedeltaIndexProperties):
    ...
    @overload
    def __truediv__(self, other: dt.timedelta) -> Index[float]: ...
    def __rtruediv__(self, other: dt.timedelta) -> Index[float]: ...  # type: ignore[override]
    @overload  # type: ignore[override]
    def __floordiv__(self, other: num) -> Self: ...
    @overload
    def __floordiv__(self, other: dt.timedelta) -> Index[int]: ...
    def __rfloordiv__(self, other: dt.timedelta) -> Index[int]: ...  # type: ignore[override]
