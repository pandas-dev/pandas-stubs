...
class Series(IndexOpsMixin, NDFrame, Generic[S1]):
    ...
    def __rand__(self, other: int |num | _ListLike | Series[S1]) -> Series[int]: ...
    ...
    def __ror__(self, other: int|num | _ListLike | Series[S1]) -> Series[int]: ...
    ...
    def __rxor__(self, other: int|num | _ListLike | Series[S1]) -> Series[int]: ...
    @overload
    def __sub__(
