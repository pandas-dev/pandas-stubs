...
class Series(IndexOpsMixin, NDFrame, Generic[S1]):
    ...
    def __and__(self, other: int |_ListLike | Series[S1]) -> Series[_bool]: ...
    ...
    def __or__(self, other: int|_ListLike | Series[S1]) -> Series[_bool]: ...
    def __radd__(self, other: num | _str | _ListLike | Series[S1]) -> Series[S1]: ...
    def __rand__(self, other: int | num | _ListLike | Series[S1]) -> Series[_bool]: ...
    ...
    def __ror__(self, other: int |num | _ListLike | Series[S1]) -> Series[_bool]: ...
    ...
    def __rxor__(self, other: int |num | _ListLike | Series[S1]) -> Series[_bool]: ...
    @overload
    def __sub__(
    ...
    def __xor__(self, other: int | _ListLike | Series[S1]) -> Series: ...
