...
class Series(IndexOpsMixin, NDFrame, Generic[S1]):
    ...
    def __ge__(self, other: Scalar | _ListLike | Series[S1]) -> Series[_bool]: ...
    def __gt__(self, other: Scalar | _ListLike | Series[S1]) -> Series[_bool]: ...
    ...
    def __le__(self, other: Scalar | _ListLike | Series[S1]) -> Series[_bool]: ...
    def __lt__(self, other: Scalar | _ListLike | Series[S1]) -> Series[_bool]: ...
    @overload
