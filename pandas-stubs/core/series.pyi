...
class Series(IndexOpsMixin[S1], ElementOpsMixin[S1], NDFrame):
    ...
    @overload
    def diff(self: Viewable[SupportsSelfSub[S2]], periods: int = ...) -> Series[S2]: ...
    ...
    @overload
    def mean(
        self: Viewable[SupportsTruedivInt[S2]],
        *,
        axis: AxisIndex | None = 0,
        skipna: _bool = True,
        level: None = None,
