...
class Series(IndexOpsMixin, NDFrame, Generic[S1]):
    ...
    @overload
    def __ge__(self, other: Timestamp) -> Series[_bool]: ...
    @overload
    def __gt__(self, other: Union[num, _ListLike, Series[S1]]) -> Series[_bool]: ...
    @overload
    def __gt__(self, other: Timestamp) -> Series[_bool]: ...
    ...
    @overload
    def __le__(self, other: Timestamp) -> Series[_bool]: ...
    @overload
    def __le__(self, other: Union[num, _ListLike, Series[S1]]) -> Series[_bool]: ...
    @overload
    def __lt__(self, other: Timestamp) -> Series[_bool]: ...
    @overload
