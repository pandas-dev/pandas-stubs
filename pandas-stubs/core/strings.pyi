...
class StringMethods(NoNewAttributesMixin, Generic[T]):
    ...
    def translate(self, table: dict[int, int | str | None]) -> T: ...
    def count(self, pat: str, flags: int = ...) -> Series[float]: ...
    def startswith(self, pat: str, na: Any = ...) -> Series[bool]: ...
    def endswith(self, pat: str, na: Any = ...) -> Series[bool]: ...
    def findall(self, pat: str, flags: int = ...) -> Series[Any]: ...
    def extract(self, pat: str, flags: int = ..., expand: bool = ...) -> T: ...
    def extractall(self, pat: str, flags: int = ...) -> T: ...
