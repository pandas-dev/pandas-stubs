...
def test_floordiv_py_scalar(left_i: pd.Series) -> None:
    ...
    check(assert_type(left_i // b, "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(left_i // i, "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(left_i // f, "pd.Series[float]"), pd.Series, np.floating)
    ...
    check(assert_type(b // left_i, "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(i // left_i, "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(f // left_i, "pd.Series[float]"), pd.Series, np.floating)
    if TYPE_CHECKING_INVALID_USAGE:
    ...
    check(assert_type(left_i.floordiv(b), "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(left_i.floordiv(i), "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(left_i.floordiv(f), "pd.Series[float]"), pd.Series, np.floating)
    if TYPE_CHECKING_INVALID_USAGE:
        left_i.floordiv(c)  # type: ignore[call-overload] # pyright: ignore[reportArgumentType,reportCallIssue]
        left_i.floordiv(s)  # type: ignore[call-overload] # pyright: ignore[reportArgumentType,reportCallIssue]
        left_i.floordiv(d)  # type: ignore[call-overload] # pyright: ignore[reportArgumentType,reportCallIssue]

    check(assert_type(left_i.rfloordiv(b), "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(left_i.rfloordiv(i), "pd.Series[int]"), pd.Series, np.integer)
    check(assert_type(left_i.rfloordiv(f), "pd.Series[float]"), pd.Series, np.floating)
    if TYPE_CHECKING_INVALID_USAGE:
