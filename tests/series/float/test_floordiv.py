...
def test_floordiv_py_scalar(left: "pd.Series[float]") -> None:
    ...
    check(
        assert_type(left // i, "pd.Series[float]"),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.floating,
    )
    ...
    check(
        assert_type(i // left, "pd.Series[float]"),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.floating,
    )
    ...
    check(
        assert_type(  # pyrefly: ignore[assert-type]
            left.floordiv(b), "pd.Series[float]"
    ...
    check(
        assert_type(  # pyrefly: ignore[assert-type]
            left.floordiv(i), "pd.Series[float]"
        ),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.floating,
    )
    check(
        assert_type(  # pyrefly: ignore[bad-argument-type]
            left.floordiv(f), "pd.Series[float]"
    ...
    check(
        assert_type(  # pyrefly: ignore[assert-type]
            left.rfloordiv(b), "pd.Series[float]"
        ),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.floating,
    )
    check(
        assert_type(  # pyrefly: ignore[assert-type]
            left.rfloordiv(i), "pd.Series[float]"
        ),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.floating,
    )
    check(
        assert_type(  # pyrefly: ignore[bad-argument-type]
            left.rfloordiv(f), "pd.Series[float]"
        ),  # pyrefly: ignore[bad-argument-type]
        pd.Series,
        np.floating,
    )
    ...
    check(
        assert_type(  # pyrefly: ignore[bad-argument-type]
            left.rfloordiv(d), "pd.Series[pd.Timedelta]"
        ),  # pyrefly: ignore[bad-argument-type]
        pd.Series,
        pd.Timedelta,
    )
