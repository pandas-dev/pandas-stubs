...
def test_mul_py_scalar(left: "pd.Series[int]") -> None:
    ...
    check(
        assert_type(left * b, "pd.Series[int]"),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.integer,
    )
    ...
    check(
        assert_type(b * left, "pd.Series[int]"),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.integer,
    )
    ...
    check(
        assert_type(left.mul(b), "pd.Series[int]"),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.integer,
    )
    check(
    ...
    check(
        assert_type(left.rmul(b), "pd.Series[int]"),  # pyrefly: ignore[assert-type]
        pd.Series,
        np.integer,
    )
    check(
