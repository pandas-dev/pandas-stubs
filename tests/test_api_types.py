...
def test_is_bool() -> None:
    ...
    check(
        assert_type(api.is_bool(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool), bool
    )
...
def test_is_bool_dtype() -> None:
    ...
    check(
        assert_type(api.is_bool_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_categorical_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_categorical_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_complex() -> None:
    ...
    check(
        assert_type(api.is_complex(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_complex_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_complex_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_datetime64_any_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_datetime64_any_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_datetime64_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_datetime64_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_datetime64_ns_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_datetime64_ns_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_datetime64tz_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_datetime64tz_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_dict_like() -> None:
    ...
    check(
        assert_type(api.is_dict_like(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_extension_array_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_extension_array_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_file_like() -> None:
    ...
    check(
        assert_type(api.is_file_like(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_float() -> None:
    ...
    check(
        assert_type(api.is_float(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool), bool
    )
...
def test_is_float_dtype() -> None:
    ...
    check(
        assert_type(api.is_float_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_hashable() -> None:
    ...
    check(
        assert_type(api.is_hashable(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_int64_dtype() -> None:
    ...
    check(
        assert_type(api.is_int64_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_integer() -> None:
    ...
    check(
        assert_type(api.is_integer(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_integer_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_integer_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_interval() -> None:
    ...
    check(
        assert_type(api.is_interval(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_iterator() -> None:
    ...
    check(
        assert_type(api.is_iterator(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_list_like() -> None:
    ...
    check(
        assert_type(api.is_list_like(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_named_tuple() -> None:
    ...
    check(
        assert_type(api.is_named_tuple(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool),
        bool,
    )
...
def test_is_number() -> None:
    ...
    check(
        assert_type(api.is_number(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool), bool
    )
...
def test_is_numeric_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_numeric_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_object_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_object_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_period_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_period_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_re_compilable() -> None:
    ...
    check(
        assert_type(
            api.is_re_compilable(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_scalar() -> None:
    ...
    check(
        assert_type(api.is_scalar(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool), bool
    )
...
def test_is_signed_integer_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_signed_integer_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_sparse() -> None:
    ...
    check(
        assert_type(api.is_sparse(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool), bool
    )
...
def test_is_string_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_string_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_timedelta64_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_timedelta64_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_timedelta64_ns_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_timedelta64_ns_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})), bool
        ),
        bool,
    )
...
def test_is_unsigned_integer_dtype() -> None:
    ...
    check(
        assert_type(
            api.is_unsigned_integer_dtype(pd.DataFrame({"a": [1, 2], "b": [3, 4]})),
            bool,
        ),
        bool,
    )
