...
def test_series_dt_accessors() -> None:
    ...
    check(assert_type(s0.dt.year, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.month, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.day, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.hour, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.minute, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.second, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.microsecond, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.nanosecond, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.dayofweek, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.day_of_week, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.weekday, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.dayofyear, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.day_of_year, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.quarter, "pd.Series[int]"), pd.Series, np.int64)
    ...
    check(assert_type(s0.dt.daysinmonth, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s0.dt.days_in_month, "pd.Series[int]"), pd.Series, np.int64)
    ...
    check(assert_type(s1.dt.qyear, "pd.Series[int]"), pd.Series, np.int64)
    ...
    check(assert_type(s2.dt.days, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s2.dt.seconds, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s2.dt.microseconds, "pd.Series[int]"), pd.Series, np.int64)
    check(assert_type(s2.dt.nanoseconds, "pd.Series[int]"), pd.Series, np.int64)
...
def test_datetimeindex_accessors() -> None:
    ...
    check(assert_type(i0.year, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.month, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.day, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.hour, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.minute, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.second, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.microsecond, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.nanosecond, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.dayofweek, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.day_of_week, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.weekday, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.dayofyear, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.day_of_year, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.quarter, NumericIndex), NumericIndex, np.int64)
    ...
    check(assert_type(i0.daysinmonth, NumericIndex), NumericIndex, np.int64)
    check(assert_type(i0.days_in_month, NumericIndex), NumericIndex, np.int64)
...
def test_timedeltaindex_accessors() -> None:
    ...
    check(assert_type(i0.days, pd.Index), pd.Index, np.int64)
    check(assert_type(i0.seconds, pd.Index), pd.Index, np.int64)
    check(assert_type(i0.microseconds, pd.Index), pd.Index, np.int64)
    check(assert_type(i0.nanoseconds, pd.Index), pd.Index, np.int64)
